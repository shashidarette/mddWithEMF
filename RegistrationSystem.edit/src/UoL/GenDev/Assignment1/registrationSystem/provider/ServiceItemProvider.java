...
/**
 * This is the item provider adapter for a {@link UoL.GenDev.Assignment1.registrationSystem.Service} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Service_serviceId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Service_serviceId_feature", "_UI_Service_type"),
				 RegistrationSystemPackage.Literals.SERVICE__SERVICE_ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RegistrationSystemPackage.Literals.SERVICE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addFeesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Service_fees_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Service_fees_feature", "_UI_Service_type"),
				 RegistrationSystemPackage.Literals.SERVICE__FEES,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RegistrationSystemPackage.Literals.SERVICE__REQUIRES_PRODUCTS,
				 true,
				 false,
				 true,
				 null,

...
/**
 * This is the item provider adapter for a {@link UoL.GenDev.Assignment1.registrationSystem.Product} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RegistrationSystemPackage.Literals.PRODUCT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCostPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Product_cost_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Product_cost_feature", "_UI_Product_type"),
				 RegistrationSystemPackage.Literals.PRODUCT__COST,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RegistrationSystemPackage.Literals.PRODUCT__PRODUCT_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
